...
$result = mysqli_query($mysqli, "DELETE FROM plans WHERE planID=$planID");
...
<?php
if(isset($_GET['adm'])){
  echo "  <meta http-equiv = \"refresh\" content = \"3; url =".$_GET['adm']."\"/>";
}
else
{?>
  <meta http-equiv = "refresh" content = "3; url = ../htmls+css/taPlanJourney.php"/>
<?php }?>
<style>
