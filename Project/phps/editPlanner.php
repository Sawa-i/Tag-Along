...
if(isset($_POST['Update'])) {	
    $planID = mysqli_real_escape_string($mysqli, $_POST['planID']);
      $party = mysqli_real_escape_string($mysqli, $_POST['party']);
      $vehicle = mysqli_real_escape_string($mysqli, $_POST['vehicle']);
    $passengers = mysqli_real_escape_string($mysqli, $_POST['passengers']);
    $pointA =mysqli_real_escape_string($mysqli, $_POST['pointA']);
      $pointB = mysqli_real_escape_string($mysqli, $_POST['pointB']);
      $date =mysqli_real_escape_string($mysqli,  $_POST['inputDate']);
    $time = mysqli_real_escape_string($mysqli, $_POST['inputTime']);  
  
    
  //'$party',vehicle='$vehicle',passengers='$passengers',pointA='$pointA',pointB='$pointB',date='$date',time='$time'
     
  $result = mysqli_query($mysqli, "UPDATE plans SET partyName= '$party',vehicle='$vehicle',passengers='$passengers',pointA='$pointA',pointB='$pointB',date='$date',time='$time' WHERE planID = '$planID'");
...
<html>
	<head>
<meta http-equiv = "refresh" content = "2; url = ../htmls+css/taPlanJourney.php"/>
